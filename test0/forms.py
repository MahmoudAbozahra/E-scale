...
#             'first_weight': forms.NumberInput(attrs={'class': 'form-control','id': 'ticket_weight'}),
...
#             'first_wieght': forms.TextInput(attrs={'class': 'form-control', 'id': 'first_wieght'}),
...
#     class Meta:
#         model = ScaleInfo
#         fields = ['weight', 'created_at', 'notes']
#         widgets = {
#             'weight': forms.NumberInput(attrs={'id': 'weight-input', 'readonly': 'readonly','class': 'form-control'}),
#             'created_at': forms.DateTimeInput(attrs={'id': 'sample_time', 'readonly': 'readonly','class': 'form-control'}),
